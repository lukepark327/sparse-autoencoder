...
if __name__ == '__main__':
    ...
    sparse_autoencoder_kl.load_state_dict(torch.load('./history/sparse_autoencoder_KL.pt', map_location=torch.device('cpu')))
    ...
    sae_kl_weights = sparse_autoencoder_kl.state_dict()['encoder.4.weight'].view(32, 1, 8, 8)
    ...
    plt.savefig('./images/sparse_autoencoder_weight_visualization.png')